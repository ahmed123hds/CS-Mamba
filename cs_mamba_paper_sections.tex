...
alternatives. On Tiny-ImageNet-200, our \cs{}-V4 achieves \todo{X.X\%} Top-1 
...
V3 Reaction-Diff   & Allen-Cahn Pattern Formation   & \todo{39.8+} \\
\textbf{V4 (Ours)} & \textbf{Complex Unitary Schrödinger} & \textbf{\todo{56.5+}} \\
\bottomrule
\end{tabular}
\label{tab:ablation}
\end{table}
